function _data(FileAttachment) {
  return FileAttachment("test@3.json").json();
}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    [
      ...
      {
        url: new URL(
          "./files/2fb0f460ca6496645ee4b620b6e35b3f4f709f5be8cbb42ead21d8e79a4b71c2cfb67ef6a7c9848b54c893d5c13cd6e656b81f41363f46a2ca1fc90d3df5a850.json",
          import.meta.url
        ),
